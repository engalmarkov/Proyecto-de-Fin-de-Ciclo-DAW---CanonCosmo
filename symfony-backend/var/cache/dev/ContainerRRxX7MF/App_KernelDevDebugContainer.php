...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AdminWebController' => 'getAdminWebControllerService',
            'App\\Controller\\AuthController' => 'getAuthControllerService',
            'App\\Controller\\CalendarioController' => 'getCalendarioControllerService',
            'App\\Controller\\CartController' => 'getCartControllerService',
            'App\\Controller\\MainController' => 'getMainControllerService',
            'App\\Controller\\PedidoController' => 'getPedidoControllerService',
            'App\\Controller\\ProductWebController' => 'getProductWebControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventSubscriber\\DebugExceptionSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\DebugExceptionSubscriber'] ??= new \App\EventSubscriber\DebugExceptionSubscriber()), 'onKernelException'], 9999);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\AdminWebController', 'App\\Controller\\AuthController', 'App\\Controller\\CalendarioController', 'App\\Controller\\CartController', 'App\\Controller\\MainController', 'App\\Controller\\PedidoController', 'App\\Controller\\ProductWebController', 'App\\Controller\\ProductoController', 'App\\Controller\\SecurityController', 'App\\Controller\\UserProfileController', 'App\\Controller\\UsuarioController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator.p1PdsOT' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_P1PdsOTService($container)
    {
        return $container->privates['.service_locator.p1PdsOT'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        $a = ($container->privates['.service_locator.p1PdsOT'] ?? self::get_ServiceLocator_P1PdsOTService($container));
        ...
        $c->registerListener('main', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\EventoCalendarioRepository' => ['privates', 'App\\Repository\\EventoCalendarioRepository', 'getEventoCalendarioRepositoryService', true],
            ...
            'App\\Repository\\EventoCalendarioRepository' => '?',
    ...
    protected static function getSerializerService($container)
    {
        ...
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, [], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer([]), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer([]), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $c), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer([]), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, []), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($b, $c, $a, $d, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($b), NULL, [], $d)], [new \Symfony\Component\Serializer\Encoder\XmlEncoder([]), new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, []), new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, []), new \Symfony\Component\Serializer\Encoder\CsvEncoder([])], []);
    }
